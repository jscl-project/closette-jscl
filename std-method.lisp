...
(defun !find-method (gf qualifiers specializers &optional (errorp t))
    ...
    (let ((method
            (find-if #'(lambda (it)
                           #+nil (#j:console:log "method" it)
                           #+nil (#j:console:log (equal qualifiers (!method-qualifiers it))
                                                 (equal specializers (!method-specializers it)))
...
(defun std-compute-discriminating-function (gf)
    ;;(break "std-compute-discriminating")
    #'(lambda (&rest args)
          ;;(break "std-cd invoke")
