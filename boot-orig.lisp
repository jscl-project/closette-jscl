...
(/debug "Figure out standard-class's slots.")
...
(/debug "Create the standard-class metaobject by hand")
...
(/debug "Install standard-class's (circular) class-of link")
...
(/debug "Fill in standard-class's class-slots.")
...
(/debug "Create the standard-object")
...
(/debug "Create the standard-class")
...
(/debug "define the other builtin classes!")
